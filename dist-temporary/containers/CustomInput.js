...
var CustomInput = function (_React$Component) {
  ...
  _createClass(CustomInput, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.value !== this.props.value) (0, _events.dispatchDateChange)();
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(_semanticUiReact.Input, this.props);
    }
  }]);
